...
// had to disable optimization here because compiler would optimize away the 
// strlen() checks before strncpy() 
void __attribute__((optimize("O0"))) parse_cmdline_args(int argc, char **argv,
